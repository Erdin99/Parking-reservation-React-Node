...
const createParkingReservation = async (id, parkingReservationDto, reservation_parking_name, reservation_parking_address, parkingReservationDto1, code, status, reservation_created_by_id) => {
    const { registration_plates, begin_reservation, end_reservation } = parkingReservationDto1;
    return ParkingReservationDAO.createParkingReservation(parkingReservationDto.id, parkingReservationDto.username, parkingReservationDto.email, id, reservation_parking_name, reservation_parking_address, registration_plates, begin_reservation, end_reservation, code, status, reservation_created_by_id);
}
